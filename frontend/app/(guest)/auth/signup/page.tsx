    ...
    <div className="bg-white pb-2">
        <section className="flex gap-4">
            <div className="w-full lg:w-7/12 my-24">
                ...
                <p className="text-red-500 text-sm">
                  {errors.find((err) => err.field === "confirm_password")?.message}
                </p>
              )}
                ...
                <p className="text-red-500 text-sm">
                  {errors.find((err) => err.field === "role")?.message}
                    ...
                    <button className="py-2 px-4 mt-6 bg-red-500 rounded-xl text-slate-50 font-bold" onClick={(e) => {
                        e.preventDefault();
                        handleSignUp()}}>
                        Sign up
                    </button>
                    ...
                    >
                        Đã có tài khoản?
                        <Link className="ml-2 text-sky-500 font-bold" href="/auth/login">Login</Link>
                    </div>
                </form>
            </div>
