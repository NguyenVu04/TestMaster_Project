...
export const signupValidationSchema = z.object({
  ...
  export const signupWithConfirmPasswordSchema = signupValidationSchema.extend({
  ...
  export type SignupValidationSchema = z.infer<typeof signupWithConfirmPasswordSchema>;
  ...
  export function validateSignupData(data: any) {
    try {
      ...
      const sortedErrors = errors.sort(
        (a: any, b: any) => desiredOrder.indexOf(a.field) - desiredOrder.indexOf(b.field)
      );
