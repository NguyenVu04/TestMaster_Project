...
('66666666-6666-6666-6666-666666666666', 'teacher1@example.com', 'admin'),
('77777777-7777-7777-7777-777777777777', 'teacher2@example.com', 'admin'),
('88888888-8888-8888-8888-888888888888', 'teacher3@example.com', 'admin'),
('99999999-9999-9999-9999-999999999999', 'teacher4@example.com', 'admin'),
('00000000-0000-0000-0000-000000000000', 'teacher5@example.com', 'admin'),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'admin1@example.com', 'admin'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'admin2@example.com', 'admin'),
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'admin3@example.com', 'admin'),
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'admin4@example.com', 'admin'),
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'admin5@example.com', 'admin');
...
('11111111-1111-1111-1111-111111111111', 'Math 101'),
('22222222-2222-2222-2222-222222222222', 'Science 101'),
('33333333-3333-3333-3333-333333333333', 'History 101'),
('44444444-4444-4444-4444-444444444444', 'English 101'),
('55555555-5555-5555-5555-555555555555', 'Art 101');

-- Insert data into "exam" table
INSERT INTO "exam" ("id", "class_id", "teacher_id", "title", "description", "attempt_limit", "passcode", "start_time", "end_time", "time_limit") VALUES
('11111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', '66666666-6666-6666-6666-666666666666', 'Math Exam 1', 'First Math Exam', 3, 'MATH123', '2025-03-21 09:00:00', '2025-03-21 11:00:00', 120),
('22222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', '77777777-7777-7777-7777-777777777777', 'Science Exam 1', 'First Science Exam', 3, 'SCI123', '2025-03-22 09:00:00', '2025-03-22 11:00:00', 120),
('33333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', '88888888-8888-8888-8888-888888888888', 'History Exam 1', 'First History Exam', 3, 'HIST123', '2025-03-23 09:00:00', '2025-03-23 11:00:00', 120),
('44444444-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444', '99999999-9999-9999-9999-999999999999', 'English Exam 1', 'First English Exam', 3, 'ENG123', '2025-03-24 09:00:00', '2025-03-24 11:00:00', 120),
('55555555-5555-5555-5555-555555555555', '55555555-5555-5555-5555-555555555555', '00000000-0000-0000-0000-000000000000', 'Art Exam 1', 'First Art Exam', 3, 'ART123', '2025-03-25 09:00:00', '2025-03-25 11:00:00', 120);
...
('22222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333', 'Exam Reminder', 'Do not forget about the exam tomorrow.', '2025-03-21 09:00:00', false),
...
-- Insert data into "class_teacher" table
